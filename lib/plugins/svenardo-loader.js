...
ig.SvenardoLoader = ig.Loader.extend({
 ...
 ctx.moveTo(51.9, 3.0);
      ...
      ctx.closePath();
      gradient = ctx.createLinearGradient(26.2, 71.9, 26.2, 1.4);
      gradient.addColorStop(0.00, "rgb(255, 255, 20)");
      gradient.addColorStop(0.07, "rgb(232, 255, 22)");
      gradient.addColorStop(0.38, "rgb(235, 172, 57)");
      gradient.addColorStop(0.54, "rgb(227, 206, 130)");
      gradient.addColorStop(0.65, "rgb(218, 239, 203)");
      gradient.addColorStop(0.78, "rgb(213, 157, 101)");
      gradient.addColorStop(0.89, "rgb(207, 74, 0)");
      gradient.addColorStop(0.95, "rgb(213, 37, 0)");
      gradient.addColorStop(0.98, "rgb(219, 0, 0)");
      ...
      ctx.closePath();
      gradient = ctx.createLinearGradient(82.1, 70.5, 82.1, 1.2);
      gradient.addColorStop(0.00, "rgb(255, 255, 20)");
      gradient.addColorStop(0.07, "rgb(232, 255, 22)");
      gradient.addColorStop(0.38, "rgb(235, 172, 57)");
      gradient.addColorStop(0.54, "rgb(227, 206, 130)");
      ...
      ctx.closePath();
      gradient = ctx.createLinearGradient(146.1, 70.7, 146.1, 1.0);
      gradient.addColorStop(0.00, "rgb(255, 255, 20)");
      gradient.addColorStop(0.07, "rgb(232, 255, 22)");
      gradient.addColorStop(0.38, "rgb(235, 172, 57)");
      gradient.addColorStop(0.54, "rgb(227, 206, 130)");
      ...
      ctx.closePath();
      gradient = ctx.createLinearGradient(235.4, 70.9, 235.4, 1.0);
      gradient.addColorStop(0.00, "rgb(255, 255, 20)");
      gradient.addColorStop(0.07, "rgb(232, 255, 22)");
      gradient.addColorStop(0.38, "rgb(235, 172, 57)");
      gradient.addColorStop(0.54, "rgb(227, 206, 130)");
      ...
      ctx.closePath();
      gradient = ctx.createLinearGradient(328.1, 70.9, 328.1, 0.4);
      gradient.addColorStop(0.00, "rgb(255, 255, 20)");
      gradient.addColorStop(0.07, "rgb(232, 255, 22)");
      gradient.addColorStop(0.38, "rgb(235, 172, 57)");
      gradient.addColorStop(0.54, "rgb(227, 206, 130)");
      ...
      ctx.closePath();
      gradient = ctx.createLinearGradient(410.7, 71.0, 410.7, 1.0);
      gradient.addColorStop(0.00, "rgb(255, 255, 20)");
      gradient.addColorStop(0.07, "rgb(232, 255, 22)");
      gradient.addColorStop(0.38, "rgb(235, 172, 57)");
      gradient.addColorStop(0.54, "rgb(227, 206, 130)");
      ...
      ctx.closePath();
      gradient = ctx.createLinearGradient(507.8, 72.0, 507.8, 1.2);
      gradient.addColorStop(0.00, "rgb(255, 255, 20)");
      gradient.addColorStop(0.07, "rgb(232, 255, 22)");
      gradient.addColorStop(0.38, "rgb(235, 172, 57)");
      gradient.addColorStop(0.54, "rgb(227, 206, 130)");
      ...
      ctx.closePath();
      gradient = ctx.createLinearGradient(568.2, 70.3, 568.2, 1.3);
      gradient.addColorStop(0.00, "rgb(255, 255, 20)");
      gradient.addColorStop(0.07, "rgb(232, 255, 22)");
      gradient.addColorStop(0.38, "rgb(235, 172, 57)");
      gradient.addColorStop(0.54, "rgb(227, 206, 130)");
